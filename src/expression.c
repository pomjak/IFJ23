...
//             else if (current_token->token_type == TOKEN_NEQ) \
//                 eq_or_neq.symbol = SYM_NEQ;                  \
...
//     if (rule == E_CONCAT_E)
//     {
//         if (operators[0].data_type == STRING_T && operators[2].data_type == STRING_T)
//             exp_type = STRING_T;
//         else
//         {
...
//                 // corection type
//                 if (operators[0].data_type == operators[2].data_type)
//                     exp_type = operators[0].data_type;
...
//     {
//         if (op_num <= 2)
//             operators[idx - op_num] = tmp->data;
//         if (tmp->data.symbol == SYM_REDUCE_END)
//             break;
//         tmp = tmp->next;
//     }
//     return op_num;
